"""
GetWithIndex — acces direct a une table via un index (oriente blocs).

L'index retourne des n° de blocs. Cet operateur lit chaque bloc
et filtre les tuples dont la colonne indexee correspond a la valeur cherchee.

Avantage vs FullScan : lit O(k_blocs) au lieu de O(N_blocs).
"""
...
class GetWithIndex(Instrumentation, Operateur):
    """Acces direct a une table via un index pre-construit."""
